...
function HomePage() {
  const [members, setMembers] = useState([
    { id: 1, name: 'Bibil', juzRead: 'Juz 1 (1-69)', isChecked: false },
    { id: 2, name: 'Peen', juzRead: 'Juz 1 (70-141)', isChecked: false },
    { id: 3, name: 'Iffah', juzRead: 'Juz 2', isChecked: true },
    { id: 4, name: 'Nia', juzRead: 'Juz 3', isChecked: false },
    { id: 5, name: 'Haniah', juzRead: 'Juz 4', isChecked: false },
    { id: 6, name: 'Wati', juzRead: 'Juz 5', isChecked: true },
    { id: 7, name: 'Fathia', juzRead: 'Juz 6', isChecked: true },
    { id: 8, name: 'Fatih', juzRead: 'Juz 7', isChecked: false },
    { id: 9, name: 'Hadi', juzRead: 'Juz 8', isChecked: false },
    { id: 10, name: 'Adib', juzRead: 'Juz 9', isChecked: true },
    { id: 11, name: 'Mukhlisin', juzRead: 'Juz 10', isChecked: false },
    { id: 12, name: 'Razan', juzRead: 'Juz 11', isChecked: false },
    { id: 13, name: 'Bintang', juzRead: 'Juz 12', isChecked: true },
    { id: 14, name: 'Alif', juzRead: 'Juz 13', isChecked: false },
    { id: 15, name: 'Ali', juzRead: 'Juz 14', isChecked: false },
    { id: 16, name: 'Syauqi', juzRead: 'Juz 15', isChecked: true },
  ]);
